define(['app'], function (app) {
    app.controller("StudentHtDashboardController", function ($scope, $localStorage, SystemUserService, StudentRegistrationService, AdminService, AppSettings, $state, $uibModal, PreExaminationService) {
        ...
        $scope.GoBack = function () {
            $state.go('Dashboard.HallTicketDownload')
        }
