define(['app'], function (app) {
    app.controller("TestingStudentApplicationController", function ($scope, $localStorage, SystemUserService, StudentRegistrationService, AdminService, AppSettings, $state, $uibModal, PreExaminationService) {
        ...
        $scope.verifyDates = function (DataType) {
            var DataType = 5
            var VerifyDate = AdminService.VerifyOMRDates(DataType);
        ...
        $scope.verifyResultDates = function () {
            var DataType = 6
            var verifyresultsDate = AdminService.VerifyResultsDates(DataType);
            verifyresultsDate.then(function (response) {
                try {
                    var res = JSON.parse(response)
        ...
        $scope.GetDashboardStatus = function (RegistrationNumber) {
            ...
            getdashboardstatus.then(function (response) {
                ...
                if ($scope.HallticketGenerated == '1') {
                    $scope.GetHallticket(RegistrationNumber);
                    $scope.verifyDates();
        ...
        //$scope.updateFeeCasteDetails = function () {
        ...
        //    let RegistrationFeeAadhar = ($scope.RegistrationFeeAadhar == null || $scope.RegistrationFeeAadhar == undefined || $scope.RegistrationFeeAadhar == '') ? '' : $scope.RegistrationFeeAadhar;
        //    let RegistrationFeeCasteNumber = ($scope.RegistrationFeeCasteNumber == null || $scope.RegistrationFeeCasteNumber == undefined || $scope.RegistrationFeeCasteNumber == '') ? '' : $scope.RegistrationFeeCasteNumber;
        //    let RegistrationFeeCasteVerified = ($scope.RegistrationFeeCasteVerified == null || $scope.RegistrationFeeCasteVerified == undefined || $scope.RegistrationFeeCasteVerified == '') ? '' : $scope.RegistrationFeeCasteVerified;

        //    var paramObj = {
        //        "RegistrationID": $scope.RegistrationId,
        //        "RegistrationNumber": $scope.RegistrationNumber,
        //        "AadharNumber": RegistrationFeeAadhar,
        //        "CasteCertificateNumber": RegistrationFeeCasteNumber,
        //        "CasteVerified": RegistrationFeeCasteVerified

        //    }
        //    //$scope.loading = true;
        //    var updatecategorydetails = AdminService.UpdateFeeCasteDetails(paramObj);
        //    updatecategorydetails.then(function (response) {
        //        try {
        //            var res = JSON.parse(response);
        //        }
        //        catch (err) { }
        ...
        $scope.PrintRankCard = function () {
            ...
            var $markstable = document.createElement("div");
            $markstable.innerHTML = '';
            $markstable.className = "Rank_Card";
        ...
        $scope.GetHallticket = function (RegistrationNumber) {
            ...
            var getdetails = AdminService.GetHallticketByRegistrationId(RegistrationID, RegistrationNumber, DataType);
