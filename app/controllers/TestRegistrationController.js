define(['app'], function (app) {
    app.controller("TestRegistrationController", function ($scope, $crypto, $localStorage, $state, $uibModal, PaymentService, StudentRegistrationService, AdminService, SystemUserService, PreExaminationService) {
        const $ctrl = this;
        ...
        $scope.Submit = function () {
            ...
            var submitstddetails = StudentRegistrationService.SubmitStdDetails($scope.StudentName, $scope.MobileNumber, $scope.CasteCategory, $scope.Aadhaar, $scope.CasteNum, $scope.CasteVerified, $scope.email, EncriptedPassword, $scope.DataType);
