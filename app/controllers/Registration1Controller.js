define(['app'], function (app) {
    app.controller("Registration1Controller", function ($scope, $http, $crypto, $localStorage, $state, $uibModal, PaymentService, StudentRegistrationService, AdminService, SystemUserService, PreExaminationService) {
        const $ctrl = this;
