define(['app'], function (app) {
    app.controller("ViewStudentDashboard", function ($scope, $localStorage, SystemUserService, StudentRegistrationService, AdminService, AppSettings, $state, $uibModal, PreExaminationService) {
        ...
        $scope.logOut = function () {
            ...
            //    //    userName: ""
            //};
            $state.go('Dashboard.ViewStudentDetails')
        }
