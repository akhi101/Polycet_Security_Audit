define(['app'], function (app) {
    app.controller("ExamCentreNRExcelController", function ($scope, $uibModal, PreExaminationService, SystemUserService, $crypto, $state, $localStorage, AdminService) {
        ...
        //$scope.getExcelData = function (ExaminationCentreID) {
        //    $scope.loading = true;
        //    $scope.NoData = false;
        //    //$scope.CentreCode = CentreCode;
        //    var getExamCenters = AdminService.GetNRExcelDownload(ExaminationCentreID,$scope.CoordinatingCentreCode);
        ...
        $scope.getExcelData = function (ExaminationCentreID) {
            $scope.loading = true;
            var exceldownload = AdminService.GetNRExcelDownload(ExaminationCentreID, $scope.CoordinatingCentreCode);
