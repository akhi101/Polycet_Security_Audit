define(['app'], function (app) {
    app.controller("DCWiseExamCentresNRDownloadController", function ($scope, $uibModal,PreExaminationService, SystemUserService, $crypto, $state, $localStorage, AdminService) {
        ...
        $scope.getExaminationCentresNRDownload = function () {
            ...
            var dcexaminationCentresReportDataNew = AdminService.GetExaminationCentresNRDownload(DataType, $scope.UserName, $scope.CoordinatingCentreCode, $scope.Session, null);
        ...
        $scope.getPhotoAttendanceData = function (ExaminationCentreID, CentreCode) {
            ...
            var getExamCenters = PreExaminationService.GetPhotoAttendance(ExaminationCentreID, $scope.CentreCode,$scope.UserName,$scope.Session,null);
