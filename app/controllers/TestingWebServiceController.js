define(['app'], function (app) {
    app.controller("TestingWebServiceController", function ($scope, $localStorage, SystemUserService, StudentRegistrationService, AdminService, AppSettings, $state, $uibModal, PreExaminationService) {
        //var authData = $localStorage.authorizationData;
        //$scope.SessionID = $localStorage.SessionID;
        //$scope.RegistrationId = authData.UserID;
        var authData=1
        $scope.RegistrationId = 1738;
        const $ctrl = this;
        $ctrl.$onInit = () => {
        ...
        if (authData == undefined) {
            ...
            //$scope.RegistrationId = 2;
            var captcha = AdminService.GetDashboardStatus($scope.RegistrationId);
            ...
            captcha.then(function (response) {
                try {
                    ...
                    $scope.RegistrationNumber = res.Table[0].RegistrationNumber
                } catch (err) {
                    $scope.GetCatcha = ''
                }
            }, function (error) {
                $scope.GetCatcha = ''
                alert('Unable to load Fee Data')
            });

        }

        $scope.DashboardStatus = function () {
            var captcha = AdminService.GetDashboardStatus($scope.RegistrationId);
            captcha.then(function (response) {
                try {
                    var res = JSON.parse(response)
        ...
        $scope.savePersonalDetails = function () {
            ...
            if ($scope.SSCVerified == true) {
                ...
                if ($scope.DOB_DATE != null && $scope.DOB_DATE !== undefined) {
                    ...
                    if (datechange == null || datechange == undefined || datechange == "") {
        ...
        $scope.saveCategoryDetails = function () {
            ...
            if ($scope.EwsCertificate == true && $scope.EWSVerified == false) {
                alert("Please Verify EWS Status");
                return;
            }

            if ($scope.CasteCategory != 1 && $scope.CasteVerified == false) {
        ...
        //    try {
        //        var res = JSON.parse(response)
        //        $scope.FeeStatus = res.Table[0].RegistrationFeesPaid
        //        $scope.ApplicationStatus = res.Table[0].ApplicationStatus
        //        $scope.HallticketStatus = res.Table[0].HallticketDownloaded
        ...
        $scope.ChangeDistricts1 = function (data) {
            $scope.TelanganaDistrict1 = data.DistrictID;
            $scope.TelanganaDistrict1Name = data.DistrictName;
            var getmandal = AdminService.GetPreferenceMandalsbyDistrict($scope.TelanganaDistrict1);
            getmandal.then(function (resp) {
                ...
                if (res.Table.length > 0) {
                    $scope.PreferanceMandalsData1 = res.Table;
                }
                else {
                    alert("data not found");
                    $scope.PreferanceMandalsData = [];
                }
        ...
        $scope.getpreferencemandalname1 = function (data) {
            $scope.PreferenceMandal1ID = data.PreferenceMandal1ID;
            $scope.PreferenceMandal1Name = data.MandalName;
        }
        $scope.getpreferencemandalname2 = function (data) {
            $scope.PreferenceMandal2ID = data.PreferenceMandal2ID;
            $scope.PreferenceMandal2Name = data.MandalName;
        }
        $scope.getpreferencemandalname3 = function (data) {
            $scope.PreferenceMandal3ID = data.PreferenceMandal3ID;
            $scope.PreferenceMandal3Name = data.MandalName;
        }

        $scope.ChangeDistricts2 = function (data) {
            $scope.TelanganaDistrict2 = data.DistrictID;
            $scope.TelanganaDistrict2Name = data.DistrictName;
            var getmandal = AdminService.GetPreferenceMandalsbyDistrict($scope.TelanganaDistrict2);
            getmandal.then(function (resp) {
                try {
                    var res = JSON.parse(resp);
                }
                ...
                if (res.Table.length > 0) {
                    $scope.PreferanceMandalsData2 = res.Table;
                }
                else {
                    alert("data not found");
                    $scope.PreferanceMandalsData = [];
        ...
        $scope.ChangeDistricts3 = function (data) {
            $scope.TelanganaDistrict3 = data.DistrictID;
            $scope.TelanganaDistrict3Name = data.DistrictName;
            var getmandal = AdminService.GetPreferenceMandalsbyDistrict($scope.TelanganaDistrict3);
            getmandal.then(function (resp) {
                try {
                    var res = JSON.parse(resp);
                }
                ...
                if (res.Table.length > 0) {
                    $scope.PreferanceMandalsData3 = res.Table;
                }
                else {
                    alert("data not found");
                    $scope.PreferanceMandalsData = [];
        ...
        $scope.getTelanganaDistricts = function () {
            var DataType = 1;
            var StateID = 0;
            var getdistrict = AdminService.GetTelanganaDistricts(DataType, StateID);
            getdistrict.then(function (resp) {
                try {
                    var res = JSON.parse(resp);
                }
                ...
                if (res.Table.length > 0) {
                    $scope.TelanganaDistrictsData = res.Table;
                }
                else {
                    $scope.TelanganaDistrictsData = [];
                }
        ...
        //$scope.UrduValues = [{ "Id": "Yes", "value": 1 }, { "Id": "No", "value": 0 }]
        //$scope.HandiCappedValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
        //$scope.NCCValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
        //$scope.SportsValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
        //$scope.CAPValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
        //$scope.PMCaresValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
        //$scope.AppearforBiologyValues = [{ "Id": "Yes", "value": true }, { "Id": "No", "value": false }]
            ...
            sscdetails.then(function (res) {
                if (res) {
                    ...
                    if (resdata.Status == 200) {
                        ...
                        $scope.loading = false;
                        $scope.SSCBUTTONCLICK = true;
                        alert("Details not found Please Check the Hall Ticket Number or Continue to fillApplication");
                ...
                $scope.loading = false;
                $scope.SSCBUTTONCLICK = true;
                alert("Details not found Please Check the Hall Ticket Number or Continue to fill Application");
                $scope.Calender = false;
            })
        ...
        $scope.getStudentDetails = function () {
            ...
            getstddetails.then(function (res) {
                ...
                if (res.Table.length > 0) {
                    ...
                    //$scope.DOB_DATE = $scope.PersonalDetails.DateofBirth
                    //$scope.DOB_DATE = $scope.PersonalDetails.DateofBirth
                    // $scope.FatherName = $scope.PersonalDetails.FatherName
                    //if ($scope.DOB_DATE != "") {
                    //    $scope.SSCDateOfBirthFound = true;
                    //    $scope.SSCDateOfBirthNotFound = false;


                    //}
                    //if ($scope.DOB_DATE=="") {
                    //    $scope.SSCDateOfBirthNotFound = true;
                    //    $scope.SSCDateOfBirthFound = false;
                ...
                if (res.Table2.length > 0) {
                    ...
                    //$scope.AadharNumber = CategoryDetails.AadharNumber
                ...
                if ($scope.CasteVerified == true || $scope.EWSVerified == true) {
                    $scope.CasteCategoryFound = true;

                }

                if ($scope.EWSVerified == 1) {
                    $scope.CasteCategoryFound = true;
                    $scope.AadharFound = $scope.Aadhaar != "" ? true : false;
                    $scope.CasteCertificateNumberFound = true;
        ...
        $scope.ChangePreference = function () {
            if ($scope.PreferenceMandal1 == $scope.PreferenceMandal2) {
                $scope.PreferenceMandal1 = "";
                $scope.PreferenceMandal2 = "";
                $scope.PreferenceMandal3 = "";
                alert("Preference Mandal is not same as other Preference Mandal")
                return;
            } else if ($scope.PreferenceMandal2 == $scope.PreferenceMandal3) {
                $scope.PreferenceMandal1 = "";
                $scope.PreferenceMandal2 = "";
                $scope.PreferenceMandal3 = "";
                alert("Preference Mandal is not same as other Preference Mandal")
                return;
            } else if ($scope.PreferenceMandal1 == $scope.PreferenceMandal3) {
                $scope.PreferenceMandal1 = "";
                $scope.PreferenceMandal2 = "";
                $scope.PreferenceMandal3 = "";
                alert("Preference Mandal is not same as other Preference Mandal")
        ...
        $scope.ChangePassword = function () {
            ...
            //};
            $state.go('TestStudentDashboard.StudentChangePassword');
        }


        $scope.logOut = function () {
            sessionStorage.loggedIn = "no";
            var GetUserLogout = SystemUserService.PostUserLogout(2, $scope.RegistrationId, $scope.SessionID);
            delete $localStorage.authorizationData;
