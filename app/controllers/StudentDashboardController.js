define(['app'], function (app) {
    app.controller("StudentDashboardController", function ($scope, $localStorage, SystemUserService, StudentRegistrationService, AdminService, AppSettings, $state, $uibModal, PreExaminationService) {
        ...
        $scope.verifyHtDates = function (DataType) {
            var DataType = 7
            ...
            VerifyDate.then(function (response) {
                ...
                else if (res[0].ResponseCode == '401') {
        ...
        $scope.verifyDates = function (DataType) {
            var DataType = 5
            var VerifyDate = AdminService.VerifyOMRDates(DataType, $scope.UserName, $scope.Session, '');
            VerifyDate.then(function (response) {
                try {
                    var res = JSON.parse(response)
        ...
        $scope.verifyResultDates = function () {
            var DataType = 6
            var verifyresultsDate = AdminService.VerifyResultsDates(DataType, $scope.UserName, $scope.Session, '');
        ...
        $scope.getDashboardStatus = function (RegistrationNumber) {
            ...
            getdashboardstatus.then(function (response) {
                ...
                if ($scope.PreviewStatus == 1 && $scope.HallticketGenerated==0) {
        ...
        $scope.GETDashboardStatus = function (RegistrationNumber) {
            ...
            getdashboardstatus.then(function (response) {
                ...
                else if ($scope.HallticketGenerated == '0') {
                    $scope.personaltab = false;
                    $scope.nextbutton = false;
                    $scope.communicationtab = false;
                    $scope.categorytab = false;
        ...
        $scope.saveCategoryDetails = function () {
            ...
            let Aadhaar = ($scope.Aadhaar == null || $scope.Aadhaar == undefined || $scope.Aadhaar == '') ? '' : window.btoa($scope.Aadhaar);
        ...
        $scope.getStudentDetails = function () {
            ...
            getstddetails.then(function (res) {
                ...
                if (res.Table2.length > 0) {
                    ...
                    if ($scope.RegistrationCasteCategory == 1) {
                        if ($scope.EWSVerified == undefined || $scope.EWSVerified == null || $scope.EWSVerified == "") {
                            ...
                            $scope.CasteCategory = $scope.RegistrationCasteCategory;
                            $scope.CasteCategoryName = $scope.RegistrationCasteName;
                            $scope.Aadhaar = window.atob($scope.RegistrationAadhar);
                            //$scope.FeeAadhaar = $scope.RegistrationFeeAadhar;
                            //$scope.FeeCasteCertNumber = $scope.RegistrationFeeCasteNumber;
                ...
                if (res.Table5.length > 0) {
                    ...
                    $scope.NewStudentPhoto = res.Table5[0].StudentPhoto;
                    ...
                    $scope.NewStudentSign = res.Table5[0].StudentSignature;
