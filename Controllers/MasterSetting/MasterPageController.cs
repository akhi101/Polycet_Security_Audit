...
namespace TSPOLYCET.Controllers.MasterSetting
{
    public class MasterPageController: BaseController
    {
        ...
        [HttpGet, ActionName("GetEditUserModules")]
        public string GetEditUserModules(int UserModuleID)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                ...
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Get_Edit_UserModules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet, ActionName("GetEditUserSubModules")]
        public string GetEditUserSubModules(int UserSubModuleID)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                ...
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Get_Edit_UserSubModules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet, ActionName("GetAllModules")]
        public string GetAllModules(int DataType)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                ...
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Get_Modules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet, ActionName("GetActiveModules")]
        public string GetActiveModules(int DataType)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
        ...
        [HttpPost, ActionName("UpdateSubModules")]
        public string UpdateSubModules([FromBody] SubModuleInfo data)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                var param = new SqlParameter[7];
                param[0] = new SqlParameter("@SubModuleID", data.SubModuleID);
                ...
                param[3] = new SqlParameter("@ModuleCardColourID", data.ModuleCardColourID);
                param[4] = new SqlParameter("@SubModuleOrder", data.SubModuleOrder);
                param[5] = new SqlParameter("@Active", data.Active);
                param[6] = new SqlParameter("@UserName", data.UserName);
            ...
            catch (Exception ex)
            {
                ...
                PolycetdbHandler.SaveErorr("SP_Update_SubModules", 0, ex.Message);
                return ex.Message;
            }
        ...
        [HttpPost, ActionName("UpdateUserModules")]
        public string UpdateUserModules([FromBody] ModuleInfo data)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                var param = new SqlParameter[3];
                param[0] = new SqlParameter("@UserModuleID", data.UserModuleID);
                param[1] = new SqlParameter("@Active", data.Active);
                param[2] = new SqlParameter("@UserName", data.UserName);

                var dt = dbHandler.ReturnDataWithStoredProcedureTable("SP_Update_UserModules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {

                PolycetdbHandler.SaveErorr("SP_Update_UserModules", 0, ex.Message);
                return ex.Message;
            }

        }

        [HttpPost, ActionName("UpdateUserSubModules")]
        public string UpdateUserSubModules([FromBody] SubModuleInfo data)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                var param = new SqlParameter[3];
                param[0] = new SqlParameter("@UserSubModuleID", data.UserSubModuleID);
                param[1] = new SqlParameter("@Active", data.Active);
                param[2] = new SqlParameter("@UserName", data.UserName);

                var dt = dbHandler.ReturnDataWithStoredProcedureTable("SP_Update_UserSubModules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {

                PolycetdbHandler.SaveErorr("SP_Update_UserSubModules", 0, ex.Message);
                return ex.Message;
            }
        ...
        [HttpGet, ActionName("GetEditSubModules")]
        public string GetEditSubModules(int SubModuleID)
        {
            try
            {
                var dbHandler = new PolycetdbHandler();
                ...
                var dt = dbHandler.ReturnDataWithStoredProcedure("SP_Get_Edit_SubModules", param);
                return JsonConvert.SerializeObject(dt);
            }
            catch (Exception ex)
            {
